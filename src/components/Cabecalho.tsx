          ...
          <li>
            {logado === null ? (
              ...
              <Link
                ...
                className="titulo-serif versalete inline-flex min-h-10 items-center rounded-sm border border-oliva/40 px-4 text-xs text-oliva transition-colors hover:bg-oliva hover:text-creme-claro"
              >
